...
import B3UploadLoadding from '@/components/upload/B3UploadLoadding';
import BulkUploadTable from '@/components/upload/BulkUploadTable';
...
export default function QuickOrderUpload(props: B3UploadProps) {
  const {
    isOpen,
    handleAddToList = () => {},
    setProductData = () => {},
  ...
  return (
    <FileUploadMain>
      ...
      <Box
        sx={{
          // maxHeight: isMobile ? '' : 'calc(100% - 160px)',
