...
const ExpNewMenu = (props: any) => {
  ...
  const { isLoading, menuData } = ExpMenuController();
  ...
  return (
    <>
      <ul className="xl:flex gap-x-7 relative z-50 nav-list xl:h-full xl:mt-0 mt-auto">
        {!isLoading &&
          menuData?.length &&
              ...
              <Fragment key={index.toString()}>
                ...
                >
                  <div className="link-wrap flex">
                    {item?.menu_link_et ? (
                      <ExpLinkParser
                        className="xl:text-xs text-base leading-5 font-medium text-primary xl:py-5 py-2.5 flex items-center relative before:h-0.5 before:bg-primary before:w-0 before:bottom-0.5 before:left-0 before:absolute xl:group-[.transparent-header]/body:text-white xl:group-[.transparent-header]/body:before:bg-white xl:group-[.menu-active]/newMenu:before:w-full before:transition-all"
                        to={item?.menu_link_et}
                      >
                        {item?.menu_icon_emd && (
                          <span className="mr-3.5 xl:hidden flex w-6 h-6">
                            <img
                        ...
                        {item?.menu_title_et}
                        <i className="icon xl:flex hidden ml-2.5 text-primary w-2 h-1.5 group-[.menu-active]/newMenu:rotate-180 transition-all xl:group-[.transparent-header]/body:text-white">
                          <IconArrowUpFill />
                        </i>
                      </ExpLinkParser>
                    ) : (
                      <p className="mb-0 xl:text-xs text-base leading-5 font-medium text-primary xl:py-5 py-2.5 flex items-center relative before:h-0.5 before:bg-primary before:w-0 before:bottom-0.5 before:left-0 before:absolute xl:group-[.transparent-header]/body:text-white xl:group-[.transparent-header]/body:before:bg-white xl:group-[.menu-active]/newMenu:before:w-full before:transition-all cursor-pointer">
                        {' '}
                        {item?.menu_icon_emd && (
                          <span className="mr-3.5 xl:hidden flex w-6 h-6">
                            <img
                  ...
                  <div
                    className={`${
                      isMobileView
                        ? 'xl:translate-x-0 h-full bg-[#EBEFF2] top-0 w-full fixed translate-x-full group-[.menu-active]/newMenu:translate-x-0 group-[.menu-active]/newMenu:right-0 duration-500 xl:transition-none transition-all xl:visible invisible group-[.menu-active]/newMenu:visible z-50'
                        : ''
                    }`}
                    style={{
