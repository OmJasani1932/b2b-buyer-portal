  ...
  return (
    <>
          ...
          <div className="container">
            ...
            {windowWidth >= 1280 && (
              <ExpPencilMenu
                ...
                ulClasses={`flex absolute -right-5 top-0 [&_span]:cursor-pointer [&_span]:relative [&_strong]:text-white [&_span]:flex [&_span]:leading-4 [&_span]:font-normal [&_span]:py-3 3xl:[&_span]:px-14 [&_span]:px-8 xl:[&_span:before]:absolute xl:[&_span:before]:-left-0.5 xl:[&_span:before]:top-0 xl:[&_span:before]:bottom-0 xl:[&_span:before]:right-0 xl:[&_span:before]:content-[''] xl:[&_span:before]:skew-x-[40deg] xl:[&_span_strong]:relative [&_span_strong]:z-10 xl:[&_li:first-child_span:before]:bg-yellow xl:[&_li:nth-child(2)_span:before]:bg-magento xl:[&_li:last-child_span:before]:bg-primary xl:[&_li:last-child_span]:pr-[93px]`}
                linkNameClasses={`group/pencilLink1 [&_.fill-svg]:transition-all [&:hover_.fill-svg]:fill-white [&:hover_.stroke-brown-color]:stroke-magento [&:hover_.fill-primary]:fill-primary [&:hover_.fill-primary]:stroke-primary items-center text-xs`}
      ...
      <header
        ...
        id={'header'}
      >
        <div className="header-container max-w-full 3xl:px-[4.6875rem] 2xl:px-10 md:px-5 px-4 xl:py-0 py-4 mx-auto">
          <div className="flex justify-end xl:flex-nowrap flex-wrap">
            <div className="logo-block flex items-center justify-start w-[80%] 3xl:w-[315px] xl:w-[200px] xl:mr-auto mr-0 xl:order-none order-0">
              <ExpLinkParser to="">
                <img
                  className="max-h-[36px] xl:max-h-[46px] max-w-[fit-content] mx-auto sm:w-full w-[230px] object-contain"
                  src={
                    ExpImageParser(
            ...
            <div className="navigation-block xl:block xl:visible invisible group-[.mobile-menu-open]:visible xl:static fixed xl:w-auto w-full bg-white left-0 top-auto right-auto bottom-0 xl:h-auto sm:h-[calc(100dvh_-168px)] h-[calc(100dvh_-164px)] z-10 xl:transform-none translate-x-full transition-all group-[.mobile-menu-open]:-translate-x-0  group-[.mobile-menu-open]:top-auto group-[.mobile-menu-open]:right-0 xl:p-0 p-7 pb-7 xl:border-t-0 border-t border-gray-50 xl:group-[.transparent-header]/body:bg-transparent duration-500">
              <div className="navigation-block-inner h-full xl:overflow-visible overflow-auto xl:pb-0 pb-0 xl:block flex flex-col justify-start [&.active-menu]:overflow-hidden">
                <div className="mobile-nav-menu xl:pb-0 pb-5 mb-6 xl:border-b-0 border-b-[2px] border-[#E5E5E5] xl:hidden flex justify-end">
                  <span
                ...
                {windowWidth < 1280 && (
                  <ExpPencilMenu
                    ...
                    liClasses={
                      'group/level nav-item w-full flex items-center flex-wrap xl:flex-nowrap mb-5'
                    }
                    linkNameClasses={
            ...
            <div className="header-search-block 3xl:ml-10 2xl:ml-[0.75rem] xl:ml-[0.9375rem]  items-center xl:flex xl:bg-white relative xl:w-auto w-full flex xl:p-0 xl:py-6 p-0 border-gray-50 xl:group-[.transparent-header]/body:bg-transparent xl:order-none order-2 xl:mt-0 mt-3">
              ...
              <form
                action=""
                className="2xl:w-[400px] xl:w-[300px] w-[calc(100%_-_56px)]"
                onSubmit={handleSubmit}
              >
                <div className="relative">
                  <i className="icon xl:text-[#CCC4C1] text-white xl:bg-transparent bg-primary xl:w-5 xl:h-5 w-[34px] h-[34px] rounded-full flex items-center justify-center absolute xl:left-3 right-1 top-1/2 -translate-y-1/2 group-[.transparent-header]/body:text-white group-[.transparent-header]/body:bg-transparent xl:p-0 p-2 group-[.transparent-header.mobile-menu-open]/body:bg-primary">
                    <IconSearch />
                  </i>
                  <input
                    ref={searchInputRef}
                    type="text"
                    className="block border border-[#ccc4c1] xl:!pl-10 !pl-4 px-5 py-[0.6875rem] leading-4 text-sm w-full placeholder-gray-200 bg-white focus-visible:shadow-none focus-visible:outline-none focus-visible:border-primary !pl-8 rounded-[4px] placeholder-gray-900 !text-xs xl:!rounded-[5px] !rounded-[30px]"
            ...
            <div className="nav-user-block 3xl:ml-10 2xl:ml-5 xl:ml-[0.9375rem] xl:order-2 order-1 xl:w-auto w-[20%]">
              <ul className="md:-mx-2.5 -mx-1.5 flex justify-end h-full">
                <li className="nav-item md:px-2.5 px-1.5 flex">
                  <ExpLinkParser
                    className="flex items-center text-[0px] xl:text-xs font-medium text-primary xl:py-5 py-0 leading-5 group-[.transparent-header]/body:text-white group-[.transparent-header.mobile-menu-open]/body:text-primary"
                    to="contact-us"
                  >
                ...
                <li className="group/account nav-item md:px-2.5 px-1.5 flex items-center relative">
                  <ExpLinkParser
                    className="flex items-center text-[0px] xl:text-xs font-medium text-primary xl:py-5 leading-5 transition-all duration-200 ease-linear relative xl:before:content-['']  xl:before:absolute  xl:before:w-full  xl:before:h-0.5  xl:before:left-0  xl:before:bottom-0  xl:before:bg-primary  xl:before:invisible  xl:before:transition-all  xl:before:duration-300  xl:before:ease-linear group-[:hover]/account:before:visible group-[.transparent-header]/body:text-white xl:group-[.transparent-header]/body:before:bg-white group-[.transparent-header.mobile-menu-open]/body:text-primary"
                    to="/#/orders"
                  >
                ...
                <li className="nav-item md:px-2.5 px-1.5 relative flex">
                  <span
                    ...
                    className="cart-link flex items-center text-[0px] xl:text-xs font-medium text-primary xl:py-5 py-0 leading-5 cursor-pointer group-[.transparent-header]/body:text-white group-[.transparent-header.mobile-menu-open]/body:text-primary"
                    ref={basketRef}
                  >
